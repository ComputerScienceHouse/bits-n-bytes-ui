...
"")
        ...
        self.timeoutLabel.setGeometry(QRect(140, 0, 141, 31))
        font = QFont()
        ...
        self.subtotalLabel_4.setGeometry(QRect(20, 140, 271, 31))
        ...
        self.pushButton_3.setGeometry(QRect(30, 320, 251, 61))
        ...
        self.textLineEdit.setGeometry(QRect(90, 220, 221, 41))
        self.phoneNumberLabel = QLabel(self.page_2)
        self.phoneNumberLabel.setObjectName(u"phoneNumberLabel")
        self.phoneNumberLabel.setGeometry(QRect(70, 180, 271, 31))
